 ...
 * @constructor
 */
const TabsCard = ({title, secondaryText, currency, labelTooltip, children}) => {
    return(
        <VStack e alignItems="left">
            {title && (<Flex className={styles.gridCard}>
                <Box p='0'>
                ...
                <Spacer />
                <Box margin="auto" p='0'>
                    <Tooltip border=" 1px solid #E0E0E0" borderRadius="4px" boxShadow="none" padding="8px" fontSize="14px" bg="#fff" color="#656464" placement='top-end'
                             label={labelTooltip} >
                        <span>
