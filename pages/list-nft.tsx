            ...
            <div>
              {listItemCheck && (
                <Tabs isFitted variant='enclosed'>
                  <TabList mb='1em'>
                    <Tab
                      _selected={{ fontSize: '1.8rem', color: 'white', background: '#405466', borderRadius: '16px 0 0 16px', fontWeight: 700 }}
                      onClick={() => setIsAuction(false)}
                    >Fixed Price</Tab>
                    <Tab
                      _selected={{ fontSize: '1.8rem', color: 'white', background: '#405466', borderRadius: '0 16px 16px 0', fontWeight: 700 }}
